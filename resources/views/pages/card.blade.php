...
<div class="row justify-content-center">
    <div class="card mt-5 col-md-6" style="min-height:40vw;background-image: url('{{asset("storage/images/card.png")}}');background-size:contain">
        <div class="card-body" >
            <div class="row" style="margin-top:15.2rem">
                <div class="col-md-4">
                    <img src="{{asset("storage/images/card-photo.png")}}" alt="" width="320" class="ps-5">
                </div>
